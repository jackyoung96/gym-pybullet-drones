...
def generate_urdf(mass=0.027, x_cm=0, y_cm=0, z_cm=0):
    ...
    with open(os.path.dirname(os.path.abspath(__file__))+"cf2x_random.urdf", 'w') as f:
        f.seek(0,0)
        f.write("<?xml version=\"1.0\" ?>\n\n"+content)

generate_urdf(0.030, 0.005, 0, 0)